...
queryUsersReachable() method to used to get the number of users who are reachable for a certain user set. This user set is defined using [UserQuery](./../models/user-query.mdx). You can use the [build()](../classes/user-query-builder#public-build-userquery.mdx) method of [UserQueryBuilder](../classes/user-query-builder.mdx) to return a UserQuery.
