...
Use the queryExecutions() method to query executions from the Convai bot. The queryExecutions() method returns a promise with an array of executions. To be more precise, it returns a promise with a [ExecutionQueryResult](../models/execution-query-result.mdx) object.
...
| ----- | ------------------------------------------------ | --------- | -------------------------- |
| query | [ExecutionMatcher](../classes/execution-matcher.mdx) | required  | Query to filter executions |