...
Refer to [Context Modifier Types](../enums/context-modifier-type.mdx) for more information on different variable scopes.
...
| public | [error](#public-errorerr-error-contextmodifier)(err: [Error](../models/error.mdx)): ContextModifier<br></br>&nbsp;&nbsp;&nbsp;Send/throw an error |
...
| Name | Type                     | Attribute | Description        |
| ---- | ------------------------ | --------- | ------------------ |
| err  | [Error](../models/error.mdx) |           | Error to be thrown |