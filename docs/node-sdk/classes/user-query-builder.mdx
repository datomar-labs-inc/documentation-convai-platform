...
| Key    | Attribute | Type          |
| ------ | --------- | ------------- |
| mode   | <ul><li>default : UserQueryMode.ALL</li></ul> | [UserQueryMode](../enums/user-query-mode.mdx) |
...
| public | [build](#public-build-userquery)(): [UserQuery](../models/user-query.mdx)<br></br>&nbsp;&nbsp;&nbsp;Build all the conditions into a single user query |
...
build() method is used to convert all the stacked conditions into a single [User Query](../models/user-query.mdx)
