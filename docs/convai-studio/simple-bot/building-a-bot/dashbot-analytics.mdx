...
Convai by itself has a Dashboard of Analytics, but you can use other chatbot analytics, such as Dashbot. In this section, we will use Dashbot integration to extend the Analytics in the bot. You can also check the [Dashbot Integration](/convai-studio/integrations/analytics/dashbot).
