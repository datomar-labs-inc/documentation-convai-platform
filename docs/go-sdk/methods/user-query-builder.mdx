...
| Method | Description |
|--------|-------------|
| [UserQueryBuilder](#userquerybuilder-uqbuilder)() \*UQBuilder | Constructor of the **[UQBuilder](../types#uqbuilder)** type |
...
The UserQueryBuilder() method is the constructor of the **[UQBuilder](../types#uqbuilder)** type that is used to stack conditions to filter users.
...
The Build() method is used to convert all the stacked conditions into a single **[UserQuery](../types#userquery)**.