...
const nodes = [
    "convai-studio/nodes/introduction", {
        ...
        "type": "category",
        "label": "Knowledge AI",
        "items": ["convai-studio/nodes/knowledge-ai/knowledge", "convai-studio/nodes/knowledge-ai/knowledge-feedback"]
    }, {
        "type": "category",
        "label": "NLP",
        ...
        "type": "category",
        "label": "Facebook",
        "items": ["convai-studio/nodes/facebook/facebook-mark-seen", "convai-studio/nodes/facebook/facebook-profile-info"]
    }, {
        "type": "category",
        "label": "Twilio",
        "items": ["convai-studio/nodes/twilio/twilio-hang-up", "convai-studio/nodes/twilio/twilio-dial", "convai-studio/nodes/twilio/twilio-twiml"]
    }, {
        "type": "category",
        "label": "Analytics",
...
const nodeSdk = [
    ...
    "node-sdk/setup", {
        ...
        "type": "category",
        "label": "Classes",
        "items": ["node-sdk/classes/context-modifier", "node-sdk/classes/execution-matcher", "node-sdk/classes/flaggable", "node-sdk/classes/session", "node-sdk/classes/user-query-builder"]
    }, {
        "type": "category",
        "label": "Models",
        "items": [
...
const analyticsIntegrations = ["convai-studio/integrations/analytics/chatbase", "convai-studio/integrations/analytics/dashbot"]
...
const simpleBot = ["convai-studio/simple-bot/understanding-convai", {
        "type": "category",
